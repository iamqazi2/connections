...
try {
    ...
    $stmt = $pdo->query("SELECT title, company, location, created_at, media_path FROM opportunity LIMIT 4");
    ...
    <div class="job-card-container">
        ...
        <div class="job-card">
            ...
            <div class="job-details">
                ...
                <div class="job-company"><?php echo htmlspecialchars($opportunity['company']); ?></div>
                <div class="job-location"><?php echo htmlspecialchars($opportunity['location']); ?></div>
